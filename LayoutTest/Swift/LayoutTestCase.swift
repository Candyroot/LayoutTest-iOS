...
open class LayoutTestCase: LYTLayoutTestCase {
    ...
    */
    open func runLayoutTests<TestableView: LYTViewProvider>(limitResults: LYTTesterLimitResults = [],
        validation: @escaping (TestableView, [AnyHashable : Any], Any?) -> Void) where TestableView: UIView {
        self.runLayoutTests(withViewProvider: TestableView.self, limitResults: limitResults) { (view, data, context) in
            if let view = view as? TestableView {
                validation(view, data as [AnyHashable : Any], context)
            } else {
    ...
    */
    open func runLayoutTestsWithViewProvider<TestableView: UIView, ViewProvider: LYTViewProvider>(_ viewProvider: ViewProvider.Type,
        limitResults: LYTTesterLimitResults = LYTTesterLimitResults(), validation: @escaping (TestableView, [AnyHashable : Any], Any?) -> Void) {
