...
class SwiftTest: LayoutTestCase {
    ...
    class TestView: UIView, LYTViewProvider {
        ...
        public static func dataSpecForTest() -> [AnyHashable : Any] {
            return [
                "context" as NSObject: LYTIntegerValues(),
                "otherVariable" as NSObject: LYTIntegerValues()
            ]
        }
        ...
        @objc static func sizesForView() -> [LYTViewSize] {
            return [
                LYTViewSize(width: NSNumber(value: LYTiPhone6Width.native)),
                LYTViewSize(width: NSNumber(value: LYTiPadWidth.native))
            ]
        }
    }
    ...
    */
    class NonViewCreationProtocol: NSObject, LYTViewProvider {
        static func dataSpecForTest() -> [AnyHashable : Any] {
            return [
                "context" as NSObject: LYTIntegerValues(),
                "otherVariable" as NSObject: LYTIntegerValues()
            ]
